...
<i>In this article, we show how signals generated by the use of an ad blocker can improve browser fingerprinting accuracy. This novel browser fingerprinting method, while oft-discussed as a theoretical source of entropy, has only just been added to FingerprintJS as of April 2021, and has never been fully described until now.

You can access all interactive demos included in this article on our [Github](https://fingerprintjs.github.io/adblocker-fingerprint-article-demos/).
</i> 
