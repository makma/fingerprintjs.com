...
authors:
  - Savannah Copland
---
# When anti-tracking makes you identifiable: how ad blockers can be used for browser fingerprinting

![](https://lh6.googleusercontent.com/FwfigX3pRuM1tkC_T1Emaj30G1bVAIQguQy9jzgTmQHV4cKqAXl3tLVJpfpAgbJxHFn31fBZH5reu8Ull8TGYq9QalIKwkbm6XDSgmzsEaoiM7glRplHdQSaZMesWtcWOKRZn5qr)
...
![An illustration showing that ad blocker hides elements and stops HTTP requests. It can depict a browser window with a HTML code inside, and an ad blocker that removes some HTML elements by their selectors and blocks some HTTP requests.](https://lh4.googleusercontent.com/nOBtmxeQ-nwYhOX1tRe0NF8mGfYdQHRnV-6G_3OXALdvGyq-fUR5DCcl-Pq_XnJsXcuzbbsYC-bmJkFQgk-JZQlp3GU0OwGGHskeDdT6dz-wgs91UCjwn40TDgaXX3msLiifBGAV)
...
Browser fingerprinting is a technique that works by reading browser attributes and combining them together into a single identifier. This identifier is stateless and works well in normal and incognito modes. You can read more about it in our previous article here: <https://fingerprintjs.com/blog/what-is-browser-fingerprinting/>
