      ...
      <Container size='large' className={styles.container}>
        ...
        <div className={styles.subHeader}>
          <p className={styles.description}>
            ...
            revenue by <strong>$2M+ ARR</strong> while keeping legitimate users happy.
          </p>
  ...
  const results = [
    {
      ...
      children: (
        <p className={styles.result}>
          The SaaS company was able to grow annual recurring revenue by more than two million USD from spun off accounts
