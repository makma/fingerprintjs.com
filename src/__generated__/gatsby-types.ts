...
enum FileFieldsEnum {
  ...
  childMarkdownRemark___frontmatter___block1___subheader = 'childMarkdownRemark.frontmatter.block1.subheader',
  childMarkdownRemark___frontmatter___block1___bullets = 'childMarkdownRemark.frontmatter.block1.bullets',
...
enum MarkdownRemarkFieldsEnum {
  ...
  frontmatter___block1___image___extension = 'frontmatter.block1.image.extension',
  frontmatter___block1___image___size = 'frontmatter.block1.image.size',
  frontmatter___block1___image___prettySize = 'frontmatter.block1.image.prettySize',
  frontmatter___block1___image___modifiedTime = 'frontmatter.block1.image.modifiedTime',
  frontmatter___block1___image___accessTime = 'frontmatter.block1.image.accessTime',
  frontmatter___block1___image___changeTime = 'frontmatter.block1.image.changeTime',
  frontmatter___block1___image___birthTime = 'frontmatter.block1.image.birthTime',
  frontmatter___block1___image___root = 'frontmatter.block1.image.root',
  frontmatter___block1___image___dir = 'frontmatter.block1.image.dir',
  frontmatter___block1___image___base = 'frontmatter.block1.image.base',
  frontmatter___block1___image___ext = 'frontmatter.block1.image.ext',
  frontmatter___block1___image___name = 'frontmatter.block1.image.name',
  frontmatter___block1___image___relativeDirectory = 'frontmatter.block1.image.relativeDirectory',
  frontmatter___block1___image___dev = 'frontmatter.block1.image.dev',
  frontmatter___block1___image___mode = 'frontmatter.block1.image.mode',
  frontmatter___block1___image___nlink = 'frontmatter.block1.image.nlink',
  frontmatter___block1___image___uid = 'frontmatter.block1.image.uid',
  frontmatter___block1___image___gid = 'frontmatter.block1.image.gid',
  frontmatter___block1___image___rdev = 'frontmatter.block1.image.rdev',
  frontmatter___block1___image___ino = 'frontmatter.block1.image.ino',
  frontmatter___block1___image___atimeMs = 'frontmatter.block1.image.atimeMs',
  frontmatter___block1___image___mtimeMs = 'frontmatter.block1.image.mtimeMs',
  frontmatter___block1___image___ctimeMs = 'frontmatter.block1.image.ctimeMs',
  frontmatter___block1___image___atime = 'frontmatter.block1.image.atime',
  frontmatter___block1___image___mtime = 'frontmatter.block1.image.mtime',
  frontmatter___block1___image___ctime = 'frontmatter.block1.image.ctime',
  frontmatter___block1___image___birthtime = 'frontmatter.block1.image.birthtime',
  frontmatter___block1___image___birthtimeMs = 'frontmatter.block1.image.birthtimeMs',
  frontmatter___block1___image___blksize = 'frontmatter.block1.image.blksize',
  frontmatter___block1___image___blocks = 'frontmatter.block1.image.blocks',
...
type MarkdownRemarkFrontmatter = {
  ...
  readonly block1: Maybe<MarkdownRemarkFrontmatterBlock1>;
};
...
type MarkdownRemarkFrontmatterFilterInput = {
  ...
  readonly block1: Maybe<MarkdownRemarkFrontmatterBlock1FilterInput>;
};
...
enum SitePageFieldsEnum {
  ...
  pluginCreator___pluginOptions___data = 'pluginCreator.pluginOptions.data',
...
enum SitePluginFieldsEnum {
  ...
  pluginOptions___plugins___pluginOptions___name = 'pluginOptions.plugins.pluginOptions.name',
  ...
  pluginOptions___plugins___pluginOptions___destinationDir = 'pluginOptions.plugins.pluginOptions.destinationDir',
  ...
  pluginOptions___data = 'pluginOptions.data',
